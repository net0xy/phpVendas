...
<body>
    <div class="container">
        ...
        <form class='form' action="./editar-cliente.php?id=<?= $cliente->getIdCliente() ?>" method="POST">
            <div class="mb-3">
            ...
            <div class="mb-3 d-flex justify-content-between">
                ...
                <div class="input">
                    ...
                    <input type="text" value="<?= $cliente->getTelefone() ?>" step="any" name="telefone" class="form-control" id="telefone" required>
                </div>
            </div>
